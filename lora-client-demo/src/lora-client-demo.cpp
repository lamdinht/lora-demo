/* 
 * Project LoRa Client Demo
 * Author: Lam Dinh
 * Date: 10/25/2023
 * Description:
 *    Project demo sending data out using Adafruit RF95 Featherwing and Particle Argon.
 */
...
RH_RF95 rf95(LoRa_CS, LoRa_IRQ);     // Instanciate a LoRa driver
